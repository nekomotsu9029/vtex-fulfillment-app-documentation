...
<html lang="en-US">
  ...
  About
</a></div> <!----></nav>  <!----> </aside> <main class="page"> <div class="theme-default-content content__default"><h1 id="escape-html"><a href="#escape-html" class="header-anchor">#</a> escape-html</h1> <p>Escape string for use in HTML</p> <h2 id="example"><a href="#example" class="header-anchor">#</a> Example</h2> <div class="language-js extra-class"><pre class="language-js"><code><span class="token keyword">var</span> escape <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'escape-html'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> html <span class="token operator">=</span> <span class="token function">escape</span><span class="token punctuation">(</span><span class="token string">'foo &amp; bar'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token comment">// -&gt; foo &amp;amp; bar</span>
</code></pre></div><h2 id="benchmark"><a href="#benchmark" class="header-anchor">#</a> Benchmark</h2> <div class="language- extra-class"><pre class="language-text"><code>$ npm run-script bench
...
&gt; node benchmark/index.js
  ...
  many special characters  x  3,175,826 ops/sec ±0.65% (193 runs sampled)
    ...
    <script src="/assets/js/app.59a89a19.js" defer></script><script src="/assets/js/2.f5d6c467.js" defer></script><script src="/assets/js/42.05d0fa0e.js" defer></script>
  </body>
</html>
